...
<div class="item bg-light" id="item-2" data-target="item-2" style="opacity:0.8">
      ...
      ?>
              ...
              <button class="bg-primary text-light pl-5 pr-5 pt-2 pb-2 float-right border-0 rounded" onclick = "createPopupWin('Curricular.php?userID=<?php echo $userID; ?>',
              'Curricular', 1200, 650);">Add</button>
              ...
              <div class="item bg-light" id="item-4" data-target="item-4" style="opacity:0.8">
                ...
                <button class="bg-primary text-light pl-5 pr-5 pt-2 pb-2 float-right border-0 rounded" onclick = "createPopupWin('SoftSkill.php?userID=<?php echo $userID; ?>',
              'Curricular', 1200, 650);">Add</button>
