  ...
  <div class="container">
    <div class="screen">
      <div class="screen__content">
        ...
        <form class="login" action = "student_authentication.php" onsubmit = "return validation()" method = "POST">
          <div class="login__field">
          <i class="fa fa-user" aria-hidden="true"></i>
            <input type="text" class="login__input" placeholder="Student ID" id ="user" name  = "user">
          </div>
          <div class="login__field">
