...
?>
	...
	<nav>
			<ul>
				...
				<a class="text-light" href="/Group4/Module5/Lecturer.php"><li>Student Monthly Progress Report</li></a>
                        <a class="text-light" href="/Group4/Module4/menu1.php"><li>Student Academic Performance(student)</li></a>
				<a class="text-light" href="/Group4/Module4/list.php"><li>Student Academic Perfomance(lecture)</li></a>
  ...
  <div class="content">
    ...
    <div class="slider-content">
		<figure class="shadow"><figcaption class="text-light text-center">Student Academic Perfomance</figcaption><a href="/Group4/Module4/list.php"><img class="rounded mx-auto d-block" style="width:100px; height:100px;" src="https://cdn-icons-png.flaticon.com/512/3094/3094910.png"></a></figure>
		<figure class="shadow"><figcaption class="text-light text-center">Student Academic Perfomance</figcaption><a href="/Group4/Module4/menu1.php"><img class="rounded mx-auto d-block" style="width:100px; height:100px;" src="https://cdn-icons-png.flaticon.com/512/3094/3094910.png"></a></figure>
		...
		<figure class="shadow"><figcaption class="text-light text-center">Consultation Record</figcaption><a href=""><img class="rounded mx-auto d-block" style="width:100px; height:100px;" src="https://cdn-icons-png.flaticon.com/512/1469/1469975.png"></a></figure>
		<figure class="shadow"><figcaption class="text-light text-center">Appointment Booking</figcaption><a href=""><img class="rounded mx-auto d-block" style="width:100px; height:100px;" src="https://cdn-icons-png.flaticon.com/512/942/942759.png"></a></figure>
