...
?>
	...
	<nav>
			<ul>
				<a class="text-light" href="#"><li>Appointment Booking</li></a>
				...
				<a class="text-light" href="result.php"><li>Student Academic Perfomance</li></a>
  ...
  <div class="content">
    ...
    <div class="slider-content">
		<figure class="shadow"><figcaption class="text-light text-center">Student Academic Perfomance</figcaption><a href="result.php"><img class="rounded mx-auto d-block" style="width:100px; height:100px;" src="https://cdn-icons-png.flaticon.com/512/3094/3094910.png"></a></figure>
