 ...
 <input type="button" value="< BACK " onclick="history.back()">
    ...
    <h1>
        <center><img
                ...
                alt="Jack Lim" width="200" height="160"></center>
    </h1>
    ...
    <table width="95%" align="center" cellpadding="1" class="SORTable">
        <tbody>
            ...
            <tr>
                ...
                <td>Email</td>
                <td width="1%">:</td>
                <td>jack@1utar.edu.my</td>
            </tr>
            <tr valign="top">
                <td colspan="3">&nbsp;</td>
                <td width="20%">Student ID</td>
                <td width="1%">:</td>
                <td width="25%">21ACB00001</td>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td width="1%">:</td>
                <td width="25%">123, Taman A, Jalan A</td>
