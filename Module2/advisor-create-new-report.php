...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="nav">
            <img src="assets/img/utar logo 1.png" alt="" class="nav-img">
        ...
        <div class="block-report">
            ...
            <div class="block-report-left">
                <table>
                    <tr class="tr">
                        <td class="field bold">
                            <label for="report-num">Report number</label>
                        </td>
                        <td class="bold">
                            <input type="text" id="report_number" placeholder="AAR-21ACB00000-000">
                        </td>
                    </tr>
                    <tr class="tr">
                        <td>
                    ...
                    <tr class="tr">
                        ...
                        <td>
                            <input type="text" id="advisee" placeholder="Name">
                        </td>
                    </tr>
                    <tr class="tr">
                        <td>
            ...
            <div class="block-report-right-container">
                <div class="block-report-right">
                    ...
                    <div class="block-report-right-status bold">Pending Report</div>
                </div>
            </div>
        </div>
...
<script>
    function postCreateReport(){
        data = {
            "report_number"             : document.getElementById('report_number') ? document.getElementById('report_number').value : "test",
            "report_date"               : 'dateNow()',
            "advisee"                   : document.getElementById('advisee') ? document.getElementById('advisee').value : "test",
           
            "academic_performance"      : document.getElementById('academic_performance') ? document.getElementById('academic_performance').value : "test",
            "class_attendance"          : document.getElementById('class_attendance') ? document.getElementById('class_attendance').value : "test",
            "cocurricular_activities"   : document.getElementById('cocurricular_activities') ? document.getElementById('cocurricular_activities').value : "test",
            "areas_for_improvement"     : document.getElementById('areas_for_improvement') ? document.getElementById('areas_for_improvement').value : "test",
            "encountered_issues"        : document.getElementById('encountered_issues') ? document.getElementById('encountered_issues').value : "test",
            "other_comments"            : document.getElementById('other_comments') ? document.getElementById('other_comments').value : "test",
        }

        post = JSON.stringify(data);
        console.log(post);
        url = "/Group4/Module2/post-create-new-report.php";
    ...
    document.getElementById("btn-ack").addEventListener("click", postCreateReport);
