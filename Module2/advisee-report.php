...
<body>
    ...
    <div class="block-back">
            <a class="btn-back-a" href="/Group4/Module2/advisee.php"><div class="btn-back">< Back</div></a>
        </div>
        <div class="nav">
        ...
        <div class="section block-ack">
            ...
            <div class="block-ack-right">
                ...
                <?php if ($report['report_status'] == 'Completed'){
                    echo "<br><br> ".$advisee['name']."<br>".date("Y/m/d");
                }
                else {
                    echo '<br><br><button class="block-ack-btn" id="btn-ack">Acknowledge Report</button>';
                }
                ?>
            </div>
...
<script>
    function postReport(){
        ...
        console.log(post);
        url = "/academic-advice-report/post-advisee-report.php";
    ...
    if(document.getElementById("btn-ack") != null){
